...
import extension_builder_stub.migrations as ext_migrations  # type: ignore[import]
import pytest_asyncio
from extension_builder_stub.crud import db  # type: ignore[import]
...
async def init_ext():
    ...
    async with db.connect() as conn:
        await run_migration(conn, ext_migrations, "extension_builder_stub")
